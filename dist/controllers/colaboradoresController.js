...
var getColaboradores = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return connection.query("SELECT * FROM colaboradores");
  ...
  return function getColaboradores(_x, _x2) {
...
var getColaborador = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connection.query("SELECT * FROM colaboradores where id = ?", [req.params.id]);
  ...
  return function getColaborador(_x3, _x4) {
...
var getColaboradoresCount = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return connection.execute("SELECT COUNT(*) FROM colaboradores");
  ...
  return function getColaboradoresCount(_x5, _x6) {
...
var saveColaborador = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 5;
            return connection.execute("insert into colaboradores(nombre,telefono)values(?,?)", [req.body.nombre, req.body.telefono]);
  ...
  return function saveColaborador(_x7, _x8) {
...
var deleteColaborador = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 5;
            return connection.execute("delete from colaboradores where id = ?", [req.params.id]);
  ...
  return function deleteColaborador(_x9, _x10) {
...
var updateColaborador = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.next = 5;
            return connection.query("update colaboradores SET ? where id = ?", [req.body, req.params.id]);
  ...
  return function updateColaborador(_x11, _x12) {
